...
This project is a web-based online bidding platform developed using Spring Boot. It enables users to participate in auctions by placing bids on listed items. The system manages bidding processes, user interactions, cart operations, and order tracking through a structured backend and a simple web interface.
...
* **Application Layer**: Processes business logic such as bidding and order handling
* **Data Layer**: Manages data storage and retrieval using JSON files

This structure improves modularity, scalability, and maintainability.
