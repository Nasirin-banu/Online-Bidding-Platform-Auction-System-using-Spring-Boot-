...
// Buyer auction card — shows winner banner + add to cart when stopped
...
// Render buyer auctions — show active + stopped (visible until seller deletes)
...
// Stop bid — calls backend which finds winner, debits buyer, credits seller, creates order
...
// Place bid — buyer enters their own amount
...
// Place order from cart — debit wallet, create order, remove from cart
...
// Update timers (only for active auctions)
